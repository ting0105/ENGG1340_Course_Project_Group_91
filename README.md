...
### CoC is a tabletop role playing game. The player can do anything he/ she want in the game, however, it is very difficult to make it happend in our project. So, we can only provide as many options as possible to player and try to provide more freedom to the player.
...
### As different people have different playing style, we allowed the player to distribute the points freely, such that they can have different playing style( eg. being more passive/active.)
